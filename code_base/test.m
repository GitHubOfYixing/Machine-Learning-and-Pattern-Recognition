...
img_path = '../pokemon dataset/train/';
...
disp([accuracy_ID, accuracy_CP, accuracy_HP, accuracy_stardust])
disp([sum(ID_gt~=ID), sum(CP_gt~=CP), sum(HP_gt~=HP), sum(stardust_gt~=stardust)])
